...
PARCHMENT   = RGBColor(0xfa, 0xf9, 0xf5)  # 玉白宣纸
IVORY       = RGBColor(0xfa, 0xf9, 0xf5)
BRAND       = RGBColor(0x2B, 0x5C, 0x8A)  # 石青
BRAND_DEEP  = RGBColor(0x2B, 0x5C, 0x8A)  # 石青
NEAR_BLACK  = RGBColor(0x2b, 0x1e, 0x14)  # 焦墨
DARK_WARM   = RGBColor(0x5e, 0x4e, 0x3f)  # 浓墨
CHARCOAL    = RGBColor(0x7a, 0x6e, 0x5f)  # 重墨
OLIVE       = RGBColor(0x9b, 0x8b, 0x7a)  # 淡墨
STONE       = RGBColor(0xc5, 0xb9, 0xa5)  # 清墨
BORDER      = RGBColor(0xc5, 0xb9, 0xa5)  # 清墨
